...
public abstract class Hilt_FullFilmFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FullFilmFragment() {
    super();
  }

  Hilt_FullFilmFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FullFilmFragment_GeneratedInjector) this.generatedComponent()).injectFullFilmFragment(UnsafeCasts.<FullFilmFragment>unsafeCast(this));
    }
  }
