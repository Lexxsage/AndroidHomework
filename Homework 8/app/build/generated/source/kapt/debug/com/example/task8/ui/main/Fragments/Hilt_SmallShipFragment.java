...
public abstract class Hilt_SmallShipFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SmallShipFragment() {
    super();
  }

  Hilt_SmallShipFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SmallShipFragment_GeneratedInjector) this.generatedComponent()).injectSmallShipFragment(UnsafeCasts.<SmallShipFragment>unsafeCast(this));
    }
  }
