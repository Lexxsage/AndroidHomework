...
public abstract class Hilt_SmallPlanetFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SmallPlanetFragment() {
    super();
  }

  Hilt_SmallPlanetFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SmallPlanetFragment_GeneratedInjector) this.generatedComponent()).injectSmallPlanetFragment(UnsafeCasts.<SmallPlanetFragment>unsafeCast(this));
    }
  }
