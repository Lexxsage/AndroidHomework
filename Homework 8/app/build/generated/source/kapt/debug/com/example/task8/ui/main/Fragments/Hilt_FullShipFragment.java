...
public abstract class Hilt_FullShipFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FullShipFragment() {
    super();
  }

  Hilt_FullShipFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FullShipFragment_GeneratedInjector) this.generatedComponent()).injectFullShipFragment(UnsafeCasts.<FullShipFragment>unsafeCast(this));
    }
  }
