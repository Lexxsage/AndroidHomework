...
public abstract class Hilt_SmallFilmFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SmallFilmFragment() {
    super();
  }

  Hilt_SmallFilmFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SmallFilmFragment_GeneratedInjector) this.generatedComponent()).injectSmallFilmFragment(UnsafeCasts.<SmallFilmFragment>unsafeCast(this));
    }
  }
